...
% Notes:
% - The \v prefix seems to be incompatible with the hyperref package
...
\usepackage{xcolor}   % for \mathcolor definition
...
\kern-.5em\raise0.5ex\hbox{$\cdot$}
\kern-0.55em\lower0.4ex\hbox{$\cdot$}
\thinspace\text{ }}}

% \mathcolor for math mode
\makeatletter
